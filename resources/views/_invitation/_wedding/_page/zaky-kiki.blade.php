    ...
    <body class="bg-navy">
        ...
        <!-- #GOLD VERSION -->
            <div class="gla_invitation_container_longer" id="gla_welcome">
                <div class="gla_invitation_i_longer gla_invitation_ii gla_image_bck text-choco-2" data-image="{{asset($cdn_link.'images/19.webp')}}"> 
                    <p style="margin-top:2vh;margin-bottom:2vh" class="ft-shadow-soft-reverse">               
                        ...
                        <span class="gla_slide_midtitle_m">Zaky & Kiki</span><br><br>
                    </p>
                </div>
            </div>
        ...
        <!-- CONTENT -->
            <div class="gla_page" id="gla_page" style="display:none">
                        ...
                        <div class="container">
                            <div class="gla_logo_container clearfix">
                                <div class="gla_logo_txt">
                                    <a href="/" class="gla_logo">Zaky & Kiki</a>
                                    <div class="gla_logo_und">22 Oktober 2022</div>
                                </div>
                            </div>
                ...
                <!-- Slider -->
                <div class="gla_slider gla_image_bck gla_wht_txt gla_fixed"  data-image="{{asset($cdn_link.'images/1.webp')}}" data-stellar-background-ratio="0.8">
                    <!-- <div class="gla_over" data-color="#1e1d2d" data-opacity="0.15"></div> -->
                    <div class="container">
                        <div class="gla_slide_txt gla_slide_center_bottom text-center">
                            <div class="gla_slide_midtitle">Z & K</div>
                        </div>
                    </div>
                ...
                <section id="gla_content" class="gla_content">
                    <section    id="profile" class="gla_section gla_image_bck gla_fixed" data-stellar-background-ratio="0.8" 
                        ...
                        <div class="container text-center">
                            <div class="col gla_round_block gla_wht_txt">
                                <span class="fix-montserrat-m">Bersatu dalam cinta dan kasih</span><br>
                                <span class="fix-montserrat-m-sb text-green-sh">Sabtu, 22 Oktober 2022</span><br><br>
                                <div class="gla_countdown" data-year="2022" data-month="10" data-day="22"></div><br><br>
                            </div>
                                ...
                                <div class="col-xs-6">
                                    <div class="gla_news_block" style="background-color:rgba(0,0,0,0.6);">
                                        ...
                                        <p class="text-choco-2">
                                            ...
                                            <span class="fix-montserrat-s-b">Mr. Dongaran Tambunan</span>
                                            <br>&<br>
                                            <span class="fix-montserrat-s-b">Mrs. Suarni Silaban</span>
                                        </p>
                                    </div>
                                </div>
                                <div class="col-xs-6">
                                    <div class="gla_news_block" style="background-color:rgba(0,0,0,0.6);">
                                        ...
                                        <span class="gla_news_title-m text-green-sh pd-sd"><strong>Kiki Riris Nababan</strong></span>
                                        ...
                                        <p class="text-choco-2">
                                            ...
                                            <span class="fix-montserrat-s-b">Mr. <small>Sabaruddin Nababan (+)</small></span>
                                            <br>&<br>
                                            <span class="fix-montserrat-s-b">Mrs. Rosmaida Rajagukguk</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <section    id="event-detail" class="gla_section gla_image_bck gla_fixed"  data-image="{{asset($cdn_link.'images/9.webp')}}" data-stellar-background-ratio="0.8">
                        <div class="container text-center">     
                            ...
                            <div class="container text-center">                
                                ...
                                <span class="fix-montserrat-s-b"><span class="text-subtitle-highlight-1">kami umumkan pernikahan ini,<br></span><span class="text-subtitle-highlight-1">kepada keluarga dan sahabat</span></span><br><br><br><br>
                                <div class="gla_icon_boxes row justify-content-center">
                                    <div class="col-sm-6 col-xs-12">
                                        <a href="#" class="gla_news_block">
                                            ...
                                            <span class="gla_news_title">Pemberkatan<br>Nikah</span>
                                            <p>
                                                <span class="fix-montserrat-sm-b text-green-sh"><b>Gereja HKBP Kota Siborongborong</b></span><br>
                                                Pasar Siborongborong, Siborongborong,<br>Tapanuli Utara, 22474<br><br><br>
                                                <span class="fix-montserrat-s-b text-green-sh">Sabtu, 22 Oktober 2022</span><br><br>
                                                <span class="label label-success">09.30 WIB</span>
                                            </p>
                                        </a>
                                    </div> 
                                    <div class="col-sm-6 col-xs-12">
                                        <a href="#" class="gla_news_block">
                                            ...
                                            <span class="gla_news_title">Acara Adat &<br>Resepsi Pernikahan </span>
                                            <p>
                                                <span class="fix-montserrat-sm-b text-green-sh"><b>Gedung Serbaguna HKBP Sabungan Siborongborong</b></span><br>
                                                Pasar Siborongborong, Siborongborong,<br>Tapanuli Utara, 22474<br><br><br>
                                                <span class="fix-montserrat-s-b text-green-sh">Sabtu, 22 Oktober 2022</span><br><br>
                                                <span class="label label-info">12.30 WIB</span>
                                            </p>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-xs-12 gla_image_bck" data-color="#fff">
                                    <div class="gla_simple_block">
                                        <h2>PEMBERKATAN <br>ZAKY & KIKI</h2>
                    ...
                    <section    id="rsvp" class="gla_section gla_image_bck gla_wht_txt gla_fixed" data-stellar-background-ratio="0.8" data-image="{{asset($cdn_link.'images/20.webp')}}">
                    ...
                    <section    id="wishes2" class="gla_section gla_image_bck gla_fixed gla_wht_txt" data-stellar-background-ratio="0.8" data-image="{{asset($cdn_link.'images/11.webp')}}">
                        <!-- <div class="gla_over" data-color="#282828" data-opacity="0.65"></div> -->
                        <div class="container text-left text-choco-1">
                    ...
                    <section    id="gift_qrcode" class="gla_section gla_image_bck gla_fixed"  data-image="{{asset($cdn_link.'images/21.webp')}}" data-stellar-background-ratio="0.8">
                        <div class="container-fluid text-center">     
                            <!-- <div class="gla_over" data-color="#ffffff" data-opacity="0.6"></div>    -->
                            <div class="container text-center">                
                                <span class="fix-montserrat-m-b text-old-green-sh highlight-2-light">Wedding Gift</span><br><br>
                                <span class="fix-montserrat-s-b text-green-sh">Tanpa mengurangi rasa hormat,<br>untuk tamu undangan yang bersedia memberikan tanda cinta, bisa melalui:
                                <p style="height:20vh"></p>
                                <div class="gla_icon_boxes row justify-content-center">
                                    <div class="col-sm-6 col-xs-6">
                                        <div class="gla_news_block">
                                            <span class="gla_news_img" style="height:auto!important"><br>
                                                <a href="{{asset($cdn_link.'images/qrcode-rezeki.jpg')}}" target="_blank">
                                                    <!-- class="lightbox" data-lightbox="qrcode">  -->
                                                    <img src="{{asset($cdn_link.'images/qrcode-rezeki.jpg')}}" download="qrcode-rezeki.jpg" 
                                                    style="height:16vh;width:16vh">
                                                </a>
                                            </span>
                                            <p onclick="copy_to_clipboard('{{$qrcode1}}')">
                                                <span class="fix-montserrat-s-b">
                                                    <label class="text-success">Mandiri - {{$qrcode1}}<br>a/n Rezeki Tambunan</label>
                                    ...
                                    <div class="col-sm-6 col-xs-6">
                                        <div class="gla_news_block">
                                            <span class="gla_news_img" style="height:auto!important"><br>
                                                <a href="{{asset($cdn_link.'images/qrcode-kiki.jpg')}}" target="_blank"> 
                                                    <!-- class="lightbox" data-lightbox="qrcode">  -->
                                                    <img src="{{asset($cdn_link.'images/qrcode-kiki.jpg')}}" download="qrcode-kiki.jpg" 
                                                    style="height:16vh;width:16vh">
                                                </a>
                                            </span>
                                            <p onclick="copy_to_clipboard('{{$qrcode2}}')">
                                                <span class="fix-montserrat-s-b">
                                                    <label class="text-success">BCA - {{$qrcode2}}<br>a/n Kiki Riris Nababan</label>
                                                    <i class="fa fa-clipboard text-secondary" aria-hidden="true" title="copy qrcode"></i>
                                                    <br><small>[copy]<small>
                                                </span>
                                            </p>
                    ...
                    <section    id="gallery" class="gla_section gla_image_bck gla_fixed gla_wht_txt" data-stellar-background-ratio="0" 
                        ...
                        <div class="container text-center"><br>
                            ...
                            <div class="gla_slider_carousel">
                                <?php
                                    $gallery_items = array('13','2','3','4','5','1','7','8','9','10','11','12','6','14','16','15','17','18','19','20','21','22','23','bride','groom'); 
                                ?>
                    ...
                    <section    id="health-protocol" class="gla_section gla_image_bck" data-color="#fff">
                        <div class="container text-center pd-md">
                            ...
                            <p class="fix-montserrat-s-b text-choco-2">Agar kita semua merasa nyaman dan aman dalam upaya pencegahan covid-19, tamu undangan yang bersedia hadir di acara tersebut dimohon untuk mematuhi protokol kesehatan berikut ini: </p><br>
                    ...
                    <section    id="quote" class="gla_image_bck gla_fixed" data-stellar-background-ratio="0.8" data-image="{{asset($cdn_link.'images/6.webp')}}">
